...
class DictionaryTest < Minitest::Test
  ...
  VALID_UNITS = ["centimeters", "kilograms", "minutes", "percent", "beats per minute", "meters", "meters per second", "drinks per day", "cigarettes", "kilograms per meter squared", "drinks", "seconds", "hours", "years", "days", "kilocalorie", "blocks", "gallons per day", "cups", "cans", "", "grams", "grams per centimeters squared", "centimeters squared"] # Add your own valid units to this array
